...
public final class Simulator {
	...
	static int weekendArrivals = 250; // average number of arriving cars per hour
	static int weekDayPassArrivals= 75; // average number of arriving cars per hour
	static int weekendPassArrivals = 40; // average number of arriving cars per hour
